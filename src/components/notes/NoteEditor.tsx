...
export function NoteEditor({ note, subjects, onChange, onDelete }: NoteEditorProps) {
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      {mode === 'edit' && (
        <div className="sticky top-0 z-10 border-b border-border bg-surface/85 px-5 py-2 backdrop-blur">
          <FormattingToolbar />
        </div>
      )}
      ...
      {/* Footer: lecture controls + word count */}
      <div className="mt-auto shrink-0">
        {mode === 'edit' && (
          <LectureRecorder
            ...
            onTitleSuggestion={(t) => {
              if (!title.trim()) updateField('title', t);
            }}
          />
        )}
